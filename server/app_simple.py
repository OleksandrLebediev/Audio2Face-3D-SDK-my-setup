...
async def infer_blendshapes(audio: UploadFile = File(...)):
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        if os.path.exists(model_data_path):
            ...
            # Создаем описание модели без numpy
            model_info = {
                "description": {
                    "model_file": "model_data.npz",
                    "note": "This NPZ file contains blendshape data including skin shapes, tongue shapes, jaw positions, and eye animations",
                    "usage": "Load this file in your 3D application to apply facial animation to your character"
                }
            }
        else:
